...
const Header = () => {
  return (
    <div className="flex items-center justify-between max-sm:flex-col-reverse gap-y-10 px-4 mt-10 lg:px-44 sm:ml-20">
      {/* left side */}
      ...
      <div className="">
        ...
        <p className="my-6  text-[15px] text-neutral-500">
          Lorem, ipsum dolor sit amet consectetur adipisicing elit. Dignissimos <br className='max-sm:hidden'/> quo pariatur ut modi rem? Sit, deleniti similique autem eveniet 
        </p>
        <div>
